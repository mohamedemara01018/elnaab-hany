...
export default function ActivitiesManagementPage() {
    ...
    // فتح نافذة التأكيد عند الضغط على أوانة الحذف
    ...
    // إيجاد العنصر المراد حذفه لعرض اسمه داخل الحوار
    ...
    return (
        <>
            <PageHeader
                ...
                lastSavedLabel="آخر حفظ: منذ ٥ دقائق"
            />
            ...
            <div className="flex-1 flex flex-col gap-6 px-6 md:px-10 pb-6">
                ...
                <section className="card">
                    <div className="flex items-center justify-between mb-1">
                        <h2 className="text-title-card text-on-surface">مجالات العمل ({items.length})</h2>
                        <button
                            type="button"
                    ...
                    <p className="text-body-small text-on-surface-variant mb-5">
                        يظهر ترتيب البطاقات في الموقع وفق الترقيم أدناه. اضغط على أيقونة القلم لتعديل أي مجال.
                    </p>
