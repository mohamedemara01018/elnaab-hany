...
import { X, Calendar, Phone, User, ExternalLink, AlertCircle, Loader2, Trash2, MessageSquare } from "lucide-react";
...
export function ComplaintDetailModal({ complaint, onClose, onUpdateStatus, onDelete }: ComplaintDetailModalProps) {
...
function ComplaintDetailModalContent({ complaint, onClose, onUpdateStatus, onDelete }: ComplaintDetailModalProps & { complaint: ComplaintRow }) {
                ...
                <div className="w-full max-w-lg bg-surface rounded-card border border-outline-variant p-6 shadow-xl space-y-5 max-h-[90vh] overflow-y-auto">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-body-small">
                            ...
                            <div className="flex items-center gap-2 text-on-surface-variant bg-surface-container-low p-2.5 rounded-interactive col-span-1 md:col-span-2">
                            ...
                            <div className="space-y-2 pt-2 border-t border-outline-variant">
                                ...
                                <div className="space-y-2 max-h-40 overflow-y-auto pr-1">
                                    {complaint.comments.map((item) => (
                                        <div key={item.id} className="p-2.5 bg-surface-container-low border border-outline-variant rounded-interactive text-body-small space-y-1">
                                            <div className="flex justify-between text-[11px] text-on-surface-variant">
                                                <span className="font-semibold text-on-surface">{item.employeeName || "الموظف"}</span>
